 ...
 */
final class Version20190427202231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD author_id INT DEFAULT NULL, CHANGE image_id image_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP author_id, CHANGE image_id image_id INT DEFAULT NULL');
    }
}
